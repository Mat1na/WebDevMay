            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav className='d-flex flex-row'>
                        ...
                        <Link to={'/#social'}><FaLinkedin fill='white' className="display-6 bg-primary p-1 rounded-1 mx-1"/></Link>
                        <Link to={'/#social'}><FaInstagram fill='white' className="display-6 bg-instagram p-1 rounded-1 mx-1"/></Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
