...
function Footer() {
  return (
    ...
    <Row className='p-3 m-0  bg-dark text-white movie-img justify-content-center align-items-center'>
      <Col md={12} className="p-0 d-flex justify-content-center details">
     <div className=' bg-dark text-light pt-2 justify-content-center'>Made by Matina &copy; 2022 MovieBlender</div>
     </Col>
